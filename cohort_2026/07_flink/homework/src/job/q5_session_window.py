"""
Q5: Session window (5-min gap) per PULocationID — find the longest session by trip count.

Run:
    docker exec -it homework-jobmanager-1 flink run -py /opt/src/job/q5_session_window.py
